...
class LiquidProductFactoryTest {
    /**
     * Method under test: {@link LiquidProductFactory#createProduct(int, String, double, boolean)}
     */
    @Test
    void testCreateProduct() {
        Product actualCreateProductResult = (new LiquidProductFactory()).createProduct(1, "Name", 10.0d, true);
